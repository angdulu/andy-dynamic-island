...
let andyCompanionWidth: CGFloat = 72
let andyCompanionHeight: CGFloat = 26
let andyCompanionExpandedWidth: CGFloat = 300
let andyCompanionExpandedHeight: CGFloat = 80
let andyCompanionGap: CGFloat = 6

func addAndyCompanionWindowWidth(to size: CGSize) -> CGSize {
    let reservedWidth = max(andyCompanionWidth, andyCompanionExpandedWidth)
    return CGSize(
        width: size.width + ((reservedWidth + andyCompanionGap) * 2),
        height: size.height
    )
}
