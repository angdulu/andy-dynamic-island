...
enum DictationPasteMethod: String, CaseIterable, Codable, Defaults.Serializable {
    case direct = "direct"
    case directAndClipboard = "directAndClipboard"
    case clipboard = "clipboard"

    var displayName: String {
        switch self {
        case .direct: return String(localized: "Direct")
        case .directAndClipboard: return String(localized: "Direct + Clipboard")
    ...
    var description: String {
        switch self {
        case .direct: return String(localized: "Insert transcribed text at the active cursor")
        case .directAndClipboard: return String(localized: "Insert transcribed text and copy it to the clipboard")
        case .clipboard: return String(localized: "Copy transcribed text to the clipboard")
        }
    }
}
...
extension Defaults.Keys {
    ...
    // MARK: Andy Feature
    static let enableAndyFeature = Key<Bool>("enableAndyFeature", default: true)

    // MARK: Dictation Feature
    static let enableScreenAssistant = Key<Bool>("enableDictationFeature", default: true)
    static let dictationOnlyMode = Key<Bool>("dictationOnlyMode", default: false)
